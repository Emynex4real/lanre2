<?php 
	$page_title = "Ranks Qualification";
	...
	<main id="main" class="main">	
		<section class="section dashboard">
			<div class="pagetitle">
				<h1>Ranks Qualification</h1>
				<nav>
				  <ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.php">Home</a></li>
					<li class="breadcrumb-item active">Ranks Qualification</li>
				  </ol>
				</nav>
			</div><!-- End Page Title -->
							...
							<div class="info-card top-selling overflow-auto">
								...
								<div class="card-body pb-0">
									<div class="flex-between ai-center no-break">
										<h5 class="card-title">Ranks Qualification</h5>
									</div>
                                    ...
                                    <table class="table table-borderless" id="complaints">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="color: #000;">Current Rank</th>
                                                <th scope="col" style="color: #000; min-width: 200px;">Team Total Investment</th>
                                                <th scope="col" style="color: #000; min-width: 300px;">Number of Level 1 Referral that have deposited</th>
                                            </tr>
                                        </thead>
                                                ...
                                                try {
                                                    if ($number_of_users > 0) { 
                                                        foreach ($user_details as $user): 
                                                            ...
                                                            $numberOfActiveLevel1Referrals = total_user_level1_that_have_deposited($user); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="min-width: 300px;"><b><?= $numberOfActiveLevel1Referrals ?></b></td>
                                                            </tr>
